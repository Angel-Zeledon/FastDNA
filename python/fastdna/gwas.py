...
def cohort_presence_matrix(paths, *, k=31, min_count=2, min_samples=2, max_kmers=None) -> CohortPresenceMatrix:
...
def export_pyseer_kmers(paths, output: _PathLike, *, k=31, min_count=2, min_samples=2) -> PyseerExport:
...
def kinship_matrix(paths, *, k=21, sketch_size=10_000) -> KinshipMatrix:
    """A sample-by-sample similarity matrix derived from FastDNA's Mash
